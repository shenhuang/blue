...
L('§3 找寻潜点（search_ready 门 + 强制开场 + found 置位）');
{
  ...
  L('  search_ready 门 · 强制开场 · search→found 置 whalefall_found + forceAscend ✓');
}
...
L('§4 鲸落生态点（found 门 · flag-gated 区点亮 · reveal ⊥ 营地）');
{
  ...
  L('  3 生态点 absolute · found 门 · 无营地也亮（reveal ⊥ 营地）✓');
}
...
console.log(log.join('\n'));
console.log('\n✓ playthrough-whalefall 完成：§1 目击链 / §2 残骸独立 / §3 找寻+found / §4 生态点 flag-gated / §5 精简营地 / §6 zone+生态 全部通过');
