...
assert(round!.version === 16, '4: SAVE_VERSION 16（round-trip 后不变·白板收口 bump）');
L('  stage flag round-trip / SAVE_VERSION 16 不变 ✓');
...
//    （#217「dev 解锁代置本区自身 beat anchor.wreck」随深度柱 beatFlag 系统删除·2026-07-12 白板收口移除——本区 beat 不再代置。）
