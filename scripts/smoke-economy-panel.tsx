...
// srcCount 随内容增减（#175 加 shaft_crack/flooded_gallery 两处旧装具掉落 → 21→23）；totalDemand 42→39（删水力发电设施·brass×3·2026-06-21）。
assert(brass && brass.srcCount === 23 && brass.totalDemand === 39, '黄铜配件 srcCount===23 且 totalDemand===39');
