...
// 侧壁/峡谷 look-dev 场景（#330·开阔水域 SPEC §6·配 zones.json 四夹具·覆盖 双壁有底/左壁临渊/右壁收口/双壁无底 四码路）
const openwaterCanyon = owScene('openwater_canyon', '开阔水域·峡谷双壁有底（声呐）', 'zone.openwater_canyon_test', 4105);
const openwaterCliff = owScene('openwater_cliff', '开阔水域·断崖左壁临渊（声呐）', 'zone.openwater_cliff_test', 4106);
const openwaterShelf = owScene('openwater_shelf', '开阔水域·半坡右壁收口（声呐）', 'zone.openwater_shelf_test', 4107);
const openwaterSlot = owScene('openwater_slot', '开阔水域·裂隙双壁无底（声呐）', 'zone.openwater_slot_test', 4108);
