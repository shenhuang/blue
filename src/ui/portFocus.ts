...
/** 港口右栏服务面板的本地 UI 态（非 phase·不入存档）：物品栏 / Otto 改装 / 打捞行会 / 潜水志图鉴 / 见闻志。
 *  'locker'＝物品栏（装备 tab 平铺所有装备·已装备加框·只看）；'upgrade'＝Otto 改装（纸娃娃 EquipmentDoll·逐件升级·SPEC §4）。 */
export type PortServiceMode = 'gear' | 'salvage' | 'bestiary' | 'lore' | 'locker' | 'upgrade';
