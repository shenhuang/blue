...
> **进度（2026-06-06）：S0（#71）+ S1（#74）+ S2（#78）+ S3 廉价版（#80）已落地；§6.5 宏观（揭示动画 + 海况遮蔽）已落地（#80）；声呐范围升级轴（§8.1 主升级轴）已接（#80）。§6.5 即时新 POI 浮现已落地（#83）；S3 定位 stalker（§8.7）已升级为「猎手」子系统、Phase 1 spine 已落地（#84·见 `docs/深海回响_猎手_SPEC.md`）。仍留：定向 ping（§5·暴露按方向计）/ 房间 feature 数升级 / 猎手 Phase 2+。**
