...
> 状态：**实装中**（2026-06-13 作者拍板·接深水区 SPEC §10 决策日志）。
...
- **wreck**：沉船墓园(0.58,0.56)·温带商船残骸◆(0.64,0.70)·塌口北缘[roam](0.70,0.62)·墓园雾区[roam](0.52,0.66)
...
- **smoke-chart-ui §A**：教学后可见＝家区 POI（东礁/旧灯塔礁/珊瑚丛◆）+ story 菱形（温带残骸/远洋中层/热液场）；
  **蓝洞群/沉船墓园改为「未揭示」**（删掉「应含」断言或改为断言 hidden）。**§A2** 改 popup 模型（断言点击 home 灯塔标记→蛙跳；或断言 home marker 存在）。
