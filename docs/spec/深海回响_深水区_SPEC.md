...
- 2026-06-12（**电池/灯装备化经济定向** · 作者同晚四件反馈之三·#118·**部分推翻 2026-06-03 0a「浅水手感＝默认灯亮·浅水近免费」拍板**·实装排期待定）：作者终态愿景——**灯与电池都是装备、要购买**；**电池买了才显示电量条**；前期电池**只能勉强支撑灯**＝从浅水起就要算电量预算；后期**材料制作**更高电量电池/更省电的灯；**声呐耗电大很多，必须升级电池才撑得住**（声呐后置解锁的既有口径不变，电池成为它的第二道门）。机制面：`EquipmentLoadout` 已有 light 槽（电池=新槽位或随 tank 族建模待定）；power/powerMax 从升级派生改为装备携带；lightDrainFactor 从近零改为真实开销（数值=作者在场逐拍手感）；经济接线走 Mira/装备购买+材料制作线。与三章科技路「电力槽」（剧情 SPEC 九批·电力槽=生长现有 power 轨）同向——电量从隐形资源升为贯穿全程的主资源轴。**牵动 0a 起全部 power/clarity 数值与回归基线＝成块 feature·需作者在场调手感·别在内容批顺手做。**
