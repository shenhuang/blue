...
| 前哨 | 铜质结核 | 铁质结核 | 铝质结核 | 银质结核 | 金质结核 | 冷光腺 |
|---|---|---|---|---|---|---|
| 残骸前哨 | 2 | – | – | – | – | 1 |
| 中层浮标 | 2 | 2 | – | – | – | 1 |
| 热液井台 | – | 2 | 2 | – | – | 1 |
...
**待确认（fresh session 开工前）**：① **金币**——旧建造有金 sink，新表未列：保留还是去掉？② **建造分段**——旧「3 阶段/前哨」，新料是收成单档还是仍摊 3 阶段？③ 蛛蟹甲壳去留；④ 海沟区(z5) 自身产不产料。**实现属经济重做（#294 同摊·deep_token 无 sink / lootFactor 删 等一并看）·非本 obs-station 结构改·建议 fresh session 一起做。**
