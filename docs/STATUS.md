...
> **2026-06-25 27 洞接 beacon 单口 + trench 清空（T3a·cave-chart·Cowork·Sonnet·#196·`5e07da5`·Mac land 49/49）**：cave roadmap T3a 完成——25 新 anchor POI（home×7/wreck×5/midwater×8/vent×5）三档发现源（直接/情报 cave_chart_page/剧情 story.ch1.anchor.*）；blue_caves 3 个 POI 迁 trench→home；trench 0 洞 POI；midwater 洞海山/孤峰语境；the_deep_gate 跳过（T2b deferred）。playthrough-chart 三处断言同步。smoke-chart-ui stale 断言漏改→#195 温度收尾修绿·quirk #171。
## 1. 一句话状态
